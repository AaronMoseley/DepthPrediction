...
if __name__ == "__main__":
    ...
    trainer = BasicDepthModelTrainer(argManager.dataset, device, "DepthPrediction-DecoderSkipConnections-AvgPool-FixedSorting-1", "modelFiles", validationSetRatio, batchSize=1)
